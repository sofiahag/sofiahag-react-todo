...
function Register() {
    ...
    <div className='w-full flex flex-row justify-center h-25 align-middle mb-20 bg-yellow-50'>
        <div className='p-7'>
            ...
            <button className='p-3 text-xs border-0 text-black rounded-full bg-gradient-to-r from-blue-100 via-cyan-100 to-blue-100 ml-10'><Link to='/'>Log in</Link></button>
        </div>
    </div>
    );
}
